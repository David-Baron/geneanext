...
if ($bt_An) Retour_Ar();
	...
	switch ($nivZone) {
		case '5' : $lib_niv = LG_AREA_SUBDIV; $lib_zone = lib_subdivision($idZone); break;
		case '4' : $lib_niv = LG_AREA_TOWN; $lib_zone = lib_ville($idZone); break;
		case '3' : $lib_niv = LG_AREA_COUNTY; $lib_zone = lib_departement($idZone); break;
		case '2' : $lib_niv = LG_AREA_REGION; $lib_zone = lib_region($idZone); break;
		case '1' : $lib_niv = LG_AREA_COUNTRY; $lib_zone = lib_pays($idZone); break;
		default  : break;
	}
