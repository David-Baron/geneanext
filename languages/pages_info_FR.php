...
<head>
    ...
    switch ($aide) {
        ...
        case 'Recherche_Personne':
            ...
            echo "<p>La sortie du résultat de la recherche peut s'effectuer sous liste cliquable (sortie &eacute;cran), sous format destin&eacute; &agrave; &ecirc;tre imprim&eacute; (sortie texte) ou sous forme de fichier CSV (pour un tableur, le s&eacute;parateur &eacute;tant le ";
        ...
        case 'Recherche_Ville':
            ...
            echo "<p>La sortie du r&eacute;sultat de la recherche peut s'effectuer sous liste cliquable (sortie &eacute;cran), sous format destin&eacute; &agrave; &ecirc;tre imprim&eacute; (sortie texte) ou sous forme de fichier CSV (pour un tableur, le s&eacute;parateur &eacute;tant le ";
            " ; disponible &agrave; partir du profil privil&eacute;gi&eacute;).</p>";
            break;
        case 'Stat_Base_Depart':
