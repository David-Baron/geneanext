...
foreach ($newscast as $news) {
    ...
    if ($news['Identifiant_zone'] != 0) {
        echo my_html($news['Titre']) . ' <a href="' . $root . '/fiche_actualite.php?refPar=' . $news['Reference'] . '">../..' . "</a>";
    } else {
...
/** @todo Not the right place to do that */
/* echo  $LG_help . ' Généamania ' . Affiche_Icone_Lien('href="' . $root . '/aide_geneamania.php"', 'help', $LG_help . ' Généamania'); */
echo '</td></tr>';
